...
public class Pet {
    ...
    private final Date dateOfBirth; //optional fields
    private final String emailAddress; //optional fields
    ...
    public static class Builder {
        ...
        private Date dateOfBirth; //optional fields
        private String emailAddress; //optional fields
        ...
        public Pet build() {
            if (animal == null ||
                ...
                throw new IllegalStateException("Cant create Pet object");
            }
